    ...
    render() {
        ...
        return (
          <Card>
            ...
            <Button onClick={()=>this.checkStudentAttendance()}>เช็คชื่อ</Button>
            ...
            <div>
              ...
              <button onClick={this.addQuestionToDatabase}>เพิ่มคำถาม</button>
            </div>
            <Button onClick={()=>this.autoReadAnswer()}>ดูคำตอบนักศึกษา</Button>
